export const messages = {
  en: {
    home: {
      ...
      a2: "Read the { 0 } and click the { 1 } button to start.",
    ...
    note: {
      ...
      new: "New",
      anon: "Anonymous",
      maxComment: "Maximum length for comments is 5000 characters",
    },
    indications: {
      indications: "Indications",
  ...
  it: {
    home: {
      ...
      a2: "Leggete le { 0 } e cliccate il tasto { 1 } per cominciare.",
