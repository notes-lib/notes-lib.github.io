...
import {
  ...
  tsxLanguage,
  typescriptLanguage
} from "./chunk-LHKYOM7E.js";
import {
  ContextTracker,
  ExternalTokenizer,
  LRParser
} from "./chunk-P3X5NEON.js";
import {
  LRLanguage,
  LanguageSupport,
  foldNodeProp,
...
function openTags(doc, tree) {
  ...
  for (let parent = tree; parent = findParentElement(parent); ) {
    let tagName2 = elementName(doc, parent);
...
].concat("beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload".split(" ").map((event) => ({ name: "on" + event, parser: javascriptLanguage.parser })));
...
//# sourceMappingURL=chunk-MMM5GMKO.js.map
